...
def main():
    ...
    if os.path.exists("D:/Project_PlantDisease/Train_CNN_Classes/weight/last.pt"):
        start_epoch, best_acc = rs.load_checkpoint(
            "D:/Project_PlantDisease/Train_CNN_Classes/weight/last.pt", model, optimizer, scaler
        )
    ...
    for epoch in range(start_epoch, TOTAL_EPOCHS):
        ...
        cb.save_checkpoint(
            ...
            scaler,
            best_acc,
            "D:/Project_PlantDisease/Train_CNN_Classes/weight/last.pt"
        )
        ...
        if val_acc > best_acc:
            ...
            cb.save_checkpoint(
                ...
                scaler,
                best_acc,
                "D:/Project_PlantDisease/Train_CNN_Classes/weight/best.pt"
            )
